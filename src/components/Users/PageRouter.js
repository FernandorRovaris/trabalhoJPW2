...
import PostCadForm from "../Posts/PostCadForm";
import PageRouterPost from "../Posts/PageRouterPost";
...
export default class PageRouter extends React.Component{
  ...
  render(){
    return  <TabContext value={this.state.tabIndex}>
              ...
              <TabPanel value="0">
                <UserList list={this.state.userlist} delete={this.deleteUser} atualizaUser={this.setUser} postar={this.postar}></UserList>
              </TabPanel>
              <TabPanel value="1">
              ...
              <TabPanel value="3">
                  <PageRouterPost user={this.state.user}></PageRouterPost>
              </TabPanel>
            </TabContext>             
  }
}