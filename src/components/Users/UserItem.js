...
export default class UserItem extends React.Component{
    ...
    render(){
        ...
        let buttomPost = <Button type="button" variant="outlined" color="secondary" onClick={this.props.postar}>Postar</Button>
        let buttomContainer = <span>{buttomDelet} {buttomEdit} {buttomPost}</span>
